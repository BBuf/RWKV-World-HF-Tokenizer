...
def load_wkv6_cuda_kernel(head_size):
    from torch.utils.cpp_extension import load as load_kernel

    global rwkv6_cuda_kernel

    kernel_folder = Path(__file__).resolve().parent.parent.parent / "kernels" / "rwkv6"
