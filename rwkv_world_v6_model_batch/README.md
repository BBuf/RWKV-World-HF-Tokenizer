...
model = AutoModelForCausalLM.from_pretrained("RWKV/rwkv-6-world-3b", trust_remote_code=True).to(torch.float32)
tokenizer = AutoTokenizer.from_pretrained("RWKV/rwkv-6-world-3b", trust_remote_code=True)
...
model = AutoModelForCausalLM.from_pretrained("RWKV/rwkv-6-world-3b", trust_remote_code=True, torch_dtype=torch.float16).to(0)
tokenizer = AutoTokenizer.from_pretrained("RWKV/rwkv-6-world-3b", trust_remote_code=True)
