...
cp ../rwkv5_model/vocab.txt ../../rwkv_model/v5-Eagle-7B/
cp ../rwkv5_model/tokenization_rwkv5.py ../../rwkv_model/v5-Eagle-7B/
cp ../rwkv5_model/tokenizer_config.json ../../rwkv_model/v5-Eagle-7B/
